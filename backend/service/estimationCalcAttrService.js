...
module.exports.createEstimationCalcAttr = async (serviceData) => {
    try {
        ...
        const findRecord = await EstimationCalcAttr.find({ calcAttributeName: estimationCalcAttr.calcAttributeName });
        ...
        findRecord.forEach(function (item) {
            ...
            if (item.estTypeId.equals(estimationCalcAttr.estTypeId) && item.calcAttributeName == estimationCalcAttr.calcAttributeName) {
