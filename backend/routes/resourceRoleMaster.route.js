...
router.get("/",
    ...
    joiSchemaValidation.validateQueryParams(joiResourceRoleMaster.getResourceRoleMasterSchema),
    resourceRoleMasterController.getAllResourceRoleMaster
);
router.post("/",
    tokenValidation.validateToken,
    joiSchemaValidation.validateBody(joiResourceRoleMaster.createResourceRoleMasterSchema),
    resourceRoleMasterController.createResourceRoleMaster
);

router.post("/estResourcePlanning/",
    tokenValidation.validateToken,
    joiSchemaValidation.validateBody(joiResourceRoleMaster.createResourceRoleMasterSchema),
    resourceRoleMasterController.createResourceRoleMaster
);
